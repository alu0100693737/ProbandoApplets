...
public class DisplayMessageApp extends JApplet {
  private String mensaje = "Mensaje por defecto"; // Message to display
  ...
  public void init() {
    ...
    panelMensaje.setFont(new Font("SansSerif", Font.BOLD, 20));
  ...
  private void getCommandLineParameters(String[] args) {
    ...
    if (args.length != 3) {
      System.out.println(
        "Modo de uso: java DisplayMessageApp x y mensaje");
      System.exit(0);
    }
    else {
